<?php
namespace RB_Section_Header\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'rb-section-header' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'rb-section-header' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'rb-section-header' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'rb-section-header' ),
			]
		);
